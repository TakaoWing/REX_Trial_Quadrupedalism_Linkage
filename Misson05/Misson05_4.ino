...
// Arudinoのプログラムの書き方は、以下のようになる
// 変数の宣言
// setup関数の中に、初期化処理を書く
// loop関数の中に、繰り返し実行する処理を書く

// Arudinoのプログラムは大きく分けて、以下の3つの部分からなる
// 変数の宣言
// setup関数
// loop関数

// 変数の宣言とは、変数を宣言することである
// 変数の宣言は、以下のように書く
// int型の変数aを宣言する場合は、以下のように書く
// int a;
// int型の変数aを宣言し、0を代入する場合は、以下のように書く
// int a = 0;
// 定数の宣言は、以下のように書く
// int型の定数aを宣言する場合は、以下のように書く
// const int a;
// int型の定数aを宣言し、0を代入する場合は、以下のように書く
// const int a = 0;

// if文とは、条件分岐を行うための文である
// if文は、以下のように書く
// if(条件式){
// 条件式が成り立った時に実行する処理
// }

// ifelse文とは、条件分岐を行うための文である
// ifelse文は、以下のように書く
// if(条件式){
// 条件式が成り立った時に実行する処理
// }else{
// 条件式が成り立たなかった時に実行する処理
// }

// if-else if-else文とは、条件分岐を行うための文である
// if-else if-else文は、以下のように書く
// if(条件式1){
// 条件式1が成り立った時に実行する処理
// }else if(条件式2){
// 条件式1が成り立たなかった時に、条件式2が成り立った時に実行する処理
// }else{
// 条件式1と条件式2が成り立たなかった時に実行する処理
// }
